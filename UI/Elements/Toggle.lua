...
return function(TabOps, label, callback)
    ...
    local sc = Instance.new("UITextSizeConstraint", Lbl)
    sc.MaxTextSize = 14; sc.MinTextSize = 8
    ...
    ToggleTrack.BackgroundColor3 = Color3.fromRGB(65, 65, 73)
